...
CREATE TABLE IF NOT EXISTS company_settings (
  ...
  office_address TEXT DEFAULT '123 Logistics Avenue, Victoria Island, Lagos, Nigeria',
  business_hours TEXT DEFAULT 'Mon – Fri: 8:00 AM – 6:00 PM (WAT) | Sat: 9:00 AM – 2:00 PM',
  logo_url TEXT,
  brand_color TEXT DEFAULT '#2563eb',
  company_description TEXT DEFAULT 'TrackPoint Global is a leading international courier and logistics company specializing in fast, secure, and reliable delivery services across Africa, Europe, the Americas, and the Middle East.',
  default_origin_country TEXT DEFAULT 'Nigeria',
  default_origin_city TEXT DEFAULT 'Lagos',
